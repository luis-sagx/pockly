export interface Translations {
  ...
  addHabit: string; habitName: string; currentStreak: string; completedLast7Days: string; weeklyCompletionRate: string; totalCheckIns: string; days: string; noHabits: string; archive: string;
...
export const productivityTranslations: Record<string, Record<string, string>> = {
  en: {
    ...
    addHabit: 'Add habit', habitName: 'Habit name', currentStreak: 'Current streak', completedLast7Days: 'Last 7 days', weeklyCompletionRate: 'Weekly rate', totalCheckIns: 'Total check-ins', days: 'days', noHabits: 'No habits yet. Start with one routine you can actually keep.', archive: 'Archive',
    ...
    notFoundTitle: 'Page not found', notFoundBody: 'That route does not exist in Productivity Tools.',
  },
  es: {
    ...
    addHabit: 'Agregar hábito', habitName: 'Nombre del hábito', currentStreak: 'Racha actual', completedLast7Days: 'Últimos 7 días', weeklyCompletionRate: 'Tasa semanal', totalCheckIns: 'Checks totales', days: 'días', noHabits: 'Todavía no hay hábitos. Empezá con una rutina que puedas sostener.', archive: 'Archivar',
    ...
    notFoundTitle: 'Página no encontrada', notFoundBody: 'Esa ruta no existe en Productivity Tools.',
  },
};
